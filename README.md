...
|  ResNet56_1	| [0.1]+[0.70]*35+[0.3]*2+[0.7]*6+[0.7]*3+[0.3]+[0.7]+[0.3]+[0.7]+[0.3]+[0.7]+[0.3]+[0.7] | 		|		|    | 
|  ResNet110	| [0.1]+[0.40]*36+[0.40]*36+[0.4]*36 		| 		|		|    | 
|  ResNet110_1	| [0.1]+[0.60]*36+[0.60]*36+[0.6]*36 		| 		|		|    | 
|  VGG16	| [0.6]+[0.4]*6+[0.6]*4+[0.6]*2 		| 		|		|    | 
|  VGG16_1	| [0.95]+[0.5]*6+[0.9]*4+[0.8]*2 		| 		|		|    | 
|  DenseNet40	| [0.0]+[0.1]*6+[0.7]*6+[0.0]+[0.1]*6+[0.7]*6+[0.0]+[0.1]*6+[0.7]*5+[0.0] 		| 		|		|    | 
|  DenseNet40_1	| [0.1]+[0.5]*6+[0.7]*6+[0.5]+[0.5]*6+[0.7]*6+[0.4]+[0.5]*6+[0.7]*5+[0.1] 		| 		|		|    | 
